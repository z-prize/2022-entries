...
fn main() {
    ...
    if nvcc.is_ok() {
        ...
        nvcc.file("cuda/mypippenger.cu").file("cuda/CudaEventWrapper.cpp").file("cuda/CudaStreamWrapper.cpp").file("cuda/pippenger_inf.cu").compile("blst_cuda_msm");
