...
typedef mont_t<255, device::Vesta_P, device::Pasta_M0,
                    device::Vesta_RR, device::Vesta_one, device::Vesta_one, device::Vesta_one> vesta_t;
typedef mont_t<255, device::Pallas_P, device::Pasta_M0,
                    device::Pallas_RR, device::Pallas_one, device::Pallas_one, device::Pallas_one> pallas_t;
# endif
#endif
