...
read_verilog -sv $CL_DIR/design/jmp/simple_dual_port_ram.sv
read_verilog -sv $CL_DIR/design/jmp/showahead_fifo.sv
read_verilog -sv $CL_DIR/design/jmp/showahead_fifo_nx1.sv
read_verilog -sv $CL_DIR/design/jmp/pcie_inorder.sv
read_verilog -sv $CL_DIR/design/jmp/piped_adder.sv
read_verilog -sv $CL_DIR/design/jmp/mul_wide.sv
read_verilog -sv $CL_DIR/design/jmp/mul_montgomery.sv
read_verilog -sv $CL_DIR/design/jmp/twisted_edwards_prek.sv
read_verilog -sv $CL_DIR/design/jmp/twisted_edwards_prek_full.sv
read_verilog -sv $CL_DIR/design/jmp/bucket_storage.sv
read_verilog -sv $CL_DIR/design/jmp/top_msm_2.sv
...
# eval [concat synth_design -include_dirs "{$CL_DIR/design $CL_DIR/design/jmp}" -top $CL_MODULE -verilog_define XSDB_SLV_DIS $VDEFINES -part [DEVICE_TYPE] -mode out_of_context $synth_options -directive $synth_directive -strategy strategy]
eval [concat synth_design -include_dirs "{$CL_DIR/design $CL_DIR/design/jmp}" -top $CL_MODULE -verilog_define XSDB_SLV_DIS $VDEFINES -part [DEVICE_TYPE] -mode out_of_context $synth_options -directive $synth_directive]
