...
pub trait DoubleInPlace {
    /// Doubles this element in place.
    fn double_in_place(&mut self) -> &mut Self;
}

// Not possible, as T could already have a Shl{,Assign} impl
// impl<'a, T> core::ops::ShlAssign<usize> for T where T: DoubleInPlace {
...
pub trait ProjectiveCurve:
    ...
    + for<'a> AddAssign<&'a <Self as ProjectiveCurve>::Affine>
    + for<'a> Add<&'a <Self as ProjectiveCurve>::Affine, Output = Self>
{
...
impl<C: ProjectiveCurve> crate::group::Group for C {
    ...
    #[inline]
    fn double_in_place(&mut self) -> &mut Self {
        <C as DoubleInPlace>::double_in_place(self)
    }
}
