...
where
    G: AffineCurve,
    G::Projective: VariableBaseMSM<G, Scalar = G::ScalarField>,
{
    ...
    let fast = <G::Projective as VariableBaseMSM<G>>::msm(g.as_slice(), v.as_slice());
    ...
    G::Projective: VariableBaseMSM<G, Scalar = G::ScalarField>,
{
    ...
    let arkworks = <G::Projective as VariableBaseMSM<G>>::msm_bigint(g.as_slice(), v.as_slice());
