...
//void NTT_2_3_in_place(GF (&in)[8], GF powers[8] );//, GF (&out)[8]);
typedef ap_uint<64> GF;
//void NTT_2_3_in_place(GF in[16777216], GF powers[16777216]);
//void NTT_2_3_in_place(GF (&in)[8], GF powers[8]);
void NTT_2_3_in_place(GF in[8], GF powers[8], GF obuf[8], GF testing[8], GF testing_2[8]);
