    ...
    Input: ToConstraintField<E::Fr> + ?Sized,
{
    ...
    fn prove_batch_with_terminator<C: ConstraintSynthesizer<E::Fr>, R: Rng + CryptoRng>(
        ...
        let (first_commitments, first_commitment_randomnesses) = {
            ...
            SonicKZG10::<E, FS>::ars_commit(
                &circuit_proving_key.committer_key,
                first_round_oracles.ars_iter_for_commit(),
                Some(zk_rng),
                1,
            )?
        };
        ...
        let (second_commitments, second_commitment_randomnesses) = SonicKZG10::<E, FS>::ars_commit_with_terminator(
            &circuit_proving_key.committer_key,
        ...
        let (third_commitments, third_commitment_randomnesses) = SonicKZG10::<E, FS>::ars_commit_with_terminator(
            &circuit_proving_key.committer_key,
        ...
        let (fourth_commitments, fourth_commitment_randomnesses) = SonicKZG10::<E, FS>::ars_commit_with_terminator(
            &circuit_proving_key.committer_key,
        ...
        let mut lc_s = std::collections::BTreeMap::new();
        let mut evaluations = std::collections::BTreeMap::new();

        (lc_s, evaluations) = AHPForR1CS::<_, MM>::ars_construct_linear_combinations(
            &public_input,
            &polynomials,
        ...
        let pc_proof = SonicKZG10::<E, FS>::ars_open_combinations(
            &circuit_proving_key.committer_key,
            lc_s.values(),
            polynomials,
            &labeled_commitments,
