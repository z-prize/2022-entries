...
#  define MAX_LG_DOMAIN_SIZE 30 // tested only up to 2^30 for now
#endif
...
#include "ntt_twiddles.cu"

#ifndef __CUDA_ARCH__

#  include "ntt_field_parameters/ntt_bls12_377.h"
...
public:
    ...
    fr_t* partial_group_gen_powers; // for LDE
...
public:
        ...
        : gpu(select_gpu(id)), inverse(_inverse)
    {
        ...
        partial_twiddles = (fr_t*)gpu.Dmalloc(2 * partial_sz * sizeof(fr_t));
        partial_group_gen_powers = partial_twiddles + partial_sz;
