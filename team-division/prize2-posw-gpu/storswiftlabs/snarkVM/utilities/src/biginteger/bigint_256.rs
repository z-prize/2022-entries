...
/*        #[cfg(target_arch = "x86_64")]
        unsafe {
            std::arch::asm!(
                ...
                R2 = lateout(reg) _,
                R3 = lateout(reg) _,
                inout("rcx") self.0.as_mut_ptr() => _,  // Self.0
                inout("rdi") other.0.as_ptr() => _,     // Other.0
                options(nostack, att_syntax)
            );
        }
        #[cfg(all(target_arch = "x86_64", feature = "unadx"))]*/
        #[cfg(target_arch = "x86_64")]
        unsafe {
            ...
            _addcarry_u64(carry, self.0[3], other.0[3], &mut self.0[3]);
        }
